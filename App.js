  ...
  return(
      <div>
        <Router>
         ...
         progress={progress}
         />
          <Switch> {/* In this category name(general,business...) are the important because newsAPI have the category 
          and we are passing the category in to the news.js file. Key is used 
           to identify the different category */}
